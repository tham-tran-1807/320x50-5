...
lib.ssMetadata = [
		{name:"320x50_atlas_1", frames: [[322,0,50,50],[425,0,43,34],[374,0,49,49],[414,51,78,19],[305,101,138,48],[425,36,62,10],[317,52,95,29],[0,52,315,47],[0,101,303,45],[0,0,320,50]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.i24();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol6, new cjs.Rectangle(0,0,138,48), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.i23();

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Symbol5, new cjs.Rectangle(0,0,78,19), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol4, new cjs.Rectangle(0,0,95,29), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(0,0,62,10), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,0,49,49), null);
...
if (reversed == null) { reversed = false; }
	...
	this.clickTag_btn.setTransform(160,45,0.4395,0.5556,0,0,0,364,81);
	...
	// logo2
	this.instance = new lib.logo21111();
	this.instance.setTransform(10,2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(55).to({_off:false},0).wait(70));

	// i2_4
	this.instance_1 = new lib.Symbol6();
	this.instance_1.setTransform(204,24,1,1,0,0,0,69,24);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(66).to({_off:false},0).to({x:191,alpha:1},11,cjs.Ease.quintInOut).wait(48));

	// i2_3
	this.instance_2 = new lib.Symbol5();
	this.instance_2.setTransform(89,24.5,1,1,0,0,0,39,9.5);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(55).to({_off:false},0).to({x:99,alpha:1},11,cjs.Ease.quintInOut).wait(59));

	// logo1
	this.instance_3 = new lib.logo1();
	this.instance_3.setTransform(5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},55).wait(70));

	// i4
	this.instance_4 = new lib.Symbol4();
	this.instance_4.setTransform(204,25.5,1,1,0,0,0,47.5,14.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(20).to({_off:false},0).to({x:193.5,alpha:1},10,cjs.Ease.quintInOut).to({_off:true},25).wait(70));

	// i3
	this.instance_5 = new lib.Symbol3();
	this.instance_5.setTransform(133,40,1,1,0,0,0,31,5);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(10).to({_off:false},0).to({x:106,y:41,alpha:1},10,cjs.Ease.quintInOut).to({_off:true},35).wait(70));

	// i2
	this.instance_6 = new lib.Symbol2();
	this.instance_6.setTransform(101.5,25.5,1,1,0,0,0,24.5,24.5);
	this.instance_6.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({x:67.5,alpha:1},10,cjs.Ease.quintInOut).to({_off:true},45).wait(70));

	// i1
	this.instance_7 = new lib.Symbol1();
	this.instance_7.setTransform(121.5,18,1,1,0,0,0,21.5,17);
	this.instance_7.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({x:93.5,alpha:1},10,cjs.Ease.quintInOut).to({_off:true},45).wait(70));

	// Texture_1
	this.instance_8 = new lib.Texture1();

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(125));
...
// library properties:
lib.properties = {
	id: '44F9EA863975794AB84D7D91364DDA68',
	width: 320,
	height: 50,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['44F9EA863975794AB84D7D91364DDA68'] = {
